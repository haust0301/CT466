...
export default {
  ...
  methods: {
    ...
    undeleteGameAlert() {
      this.$swal({
        title: "¿Bạn sẽ khôi phục bài viết này?",
        text: `Bài viết '${this.title}' sẽ khôi phục.`,
        icon: "warning",
    ...
    undeleteGame() {
      return this.axios
        ...
        .then((res) => {
          this.$swal({
            icon: "success",
            title: `Bài viết '${res.data.game.title}' đã được khôi phục.`,
          });
